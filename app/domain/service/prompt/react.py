# ReActAgent系统提示词模板
REACT_SYSTEM_PROMPT = """
你是一个任务执行智能体 (ReActAgent), 你需要按照以下步骤完成任务:
...
# FIXME: any better way to handle output format?
...
JSON 输出示例：
{{
    "message": "所有任务步骤已完成, 我已经为您处理了所有数据, 主要发现如下:\n1. 增长率...\n2. 异常值...\n详细报告请查看附件。",
    "attachments": [
